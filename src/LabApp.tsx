...
import { ArrowRight, ChevronLeft, ChevronRight, Maximize, Moon, Pause, Play, RotateCcw, Send, Sun, X } from 'lucide-react'
...
import { ClassroomBus, type ConnectionState } from './supabase'
...
export default function LabApp({ room }: { room: string }) {
  return location.pathname.startsWith('/input') ? <InputPage room={room}/> : <DisplayPage room={room}/>
}
